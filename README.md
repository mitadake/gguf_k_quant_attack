...
The blend strength `s` is anti-correlated with the target's bin width:
...
If you want the "all-at-once" multi-target attack (paper §4.2) you'll
need to merge multiple anchors — not yet implemented.
